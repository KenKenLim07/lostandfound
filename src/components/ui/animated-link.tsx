  ...
  ({ href, children, className, onClick, delay = 1000, trigger = true, ...props }, ref) => {
    ...
    return (
      <Link
        ...
        onClick={onClick}
        className={cn(
          "relative text-xs font-semibold text-muted-foreground hover:text-foreground uppercase tracking-wide px-2 pb-1 transition-colors duration-200 group text-right",
          className
        )}
        {...props}
      >
